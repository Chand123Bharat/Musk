...
<div style="text-align:right;"><p>Click the button to print the current page.</p>

<div style="text-align:right;"><button onclick="window.print()">Print this page</button>
